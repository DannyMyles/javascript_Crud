...
function readFormData() {
    ...
    formData["mc"] = document.getElementById("mc").value;
...
function insertNewRecord(data) {
    ...
    cell3.innerHTML = data.mc;
    cell4 = newRow.insertCell(3);
    cell4.innerHTML = data.tm;
...
function onEdit(td) {
    ...
    document.getElementById("mc").value = selectedRow.cells[2].innerHTML;
    document.getElementById("tm").value = selectedRow.cells[3].innerHTML;
}
function updateRecord(formData) {
    selectedRow.cells[0].innerHTML = formData.fullName;
    selectedRow.cells[1].innerHTML = formData.stack;
    selectedRow.cells[2].innerHTML = formData.mc;
    selectedRow.cells[3].innerHTML = formData.tm;
}
